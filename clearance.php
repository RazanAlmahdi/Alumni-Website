...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <img src="images/background.png" alt="Club logo" width="100%">
            <div class="container">
        <!-- form -->
        <form class="form" action="addClearance.php" method="post" id="form">
          <fieldset>
            ...
            <input  type="text" name="thesis" class="name">
            <br></br>
            <label> Supervisor </label> <br>
            <input  type="text" name="super" class="name">
            <br></br>
        ...
        <a href='editClearance.php'><p><button>Edit Clearance</button></p></a></div>
        <a href='viewMyClearance.php'><p><button style="margin-left:5em;">View Clearance</button></p></a></div>
        </div>
        <br><br>
